#ifndef __IMPL_KALINOV_ARRAY_BLOCK_BASED_KEYED_DYNAMIC_ARRAY_HPP__
#define __IMPL_KALINOV_ARRAY_BLOCK_BASED_KEYED_DYNAMIC_ARRAY_HPP__
...
class BlockBasedKeyedDynamicArray {
 ...
 private:
  ...
  void MaybeRebalance() {
    ...
    if (target_block_size_ > 10 && size() < target_block_size_ * target_block_size_ / 4) {
      target_block_size_ /= 2;
      for (int i = 0; i < blocks_.size(); ++i) {
        MaybeMerge(i);
      }
...
#endif  // __IMPL_KALINOV_ARRAY_BLOCK_BASED_KEYED_DYNAMIC_ARRAY_HPP__
