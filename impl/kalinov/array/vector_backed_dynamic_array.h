#ifndef IMPL_KALINOV_ARRAY_VECTOR_BACKED_DYNAMIC_ARRAY_H_
#define IMPL_KALINOV_ARRAY_VECTOR_BACKED_DYNAMIC_ARRAY_H_
...
#endif  // IMPL_KALINOV_ARRAY_VECTOR_BACKED_DYNAMIC_ARRAY_H_
